...
gulp.task('traceurify', function () {
  return gulp.src(['app/scripts/*.js'])
    .pipe(traceur({modules: 'commonjs'}))
    .pipe(gulp.dest('app/traceurified'));
});


gulp.task('browserify', ['traceurify', 'traceur:runtime'], function () {

  return browserify({ debug: true })
    .require(require.resolve('app/traceurified/main.js'), { entry: true })
    .bundle()
    .pipe(exorcist('app/scripts/bundle.js.map'))
    .pipe(fs.createWriteStream('app/scripts/bundle.js'));
});

// Lint JavaScript
gulp.task('jshint', function () {
  return gulp.src(['app/scripts/**/*.js', '!app/scripts/bundle.js', '!app/scripts/traceur-runtime.js'])
